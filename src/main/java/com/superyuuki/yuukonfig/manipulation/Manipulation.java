...
public interface Manipulation {
    ...
    default YamlNode serialize(Object object, Class<?> under, String[] comment) {
    ...
    YamlNode serialize(Object object, Class<?> under, String[] comment, Contextual<Type> typeCtx);
